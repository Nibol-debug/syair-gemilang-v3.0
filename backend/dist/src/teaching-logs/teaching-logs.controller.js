...
exports.TeachingLogsController = void 0;
...
let TeachingLogsController = class TeachingLogsController {
    teachingLogsService;
    constructor(teachingLogsService) {
        this.teachingLogsService = teachingLogsService;
    }
    create(createTeachingLogDto) {
...
exports.TeachingLogsController = TeachingLogsController = __decorate([
    ...
    __metadata("design:paramtypes", [teaching_logs_service_1.TeachingLogsService])
], TeachingLogsController);
//# sourceMappingURL=teaching-logs.controller.js.map